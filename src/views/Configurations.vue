<template>
  <div class="pa-4 text-center">
    <v-card prepend-icon="mdi-cog-outline" title="Configurations">
      <v-card-text>
        <v-row dense>
          <v-col cols="12" md="6">
      ...
      <v-card-actions>
        ...
        <v-btn color="red" text="Close" variant="plain"></v-btn>

        <v-btn color="success" text="Save" variant="tonal"></v-btn>
      </v-card-actions>
    </v-card>
  </div>
</template>
