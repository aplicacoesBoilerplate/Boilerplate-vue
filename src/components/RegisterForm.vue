    ...
    <v-form v-model="valid">
      <v-container class="d-flex justify-center mb-6">
        <v-col cols="6">
          <v-row>
            <v-col cols="6">
              <v-text-field clearable v-model="firstname" :counter="10" :rules="nameRules" label="First name"
                required></v-text-field>
            </v-col>

            <v-col cols="6">
              <v-text-field clearable v-model="lastname" :counter="10" :rules="nameRules" label="Last name"
                required></v-text-field>
            </v-col>
