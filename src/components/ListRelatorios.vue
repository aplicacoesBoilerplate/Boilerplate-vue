    ...
    <v-card class="mx-auto" max-width="2000">
        <v-card-title class="d-flex justify-space-between align-center">
            ...
            <InputUpperCase v-model:="paginadorClass.search" :style="{
                ...
                btnVariant: 'text',
                label: 'Consultar modelo de relatório',
                showPrepend: true,
                hideDetails: true,
                maxWidth: 500,
                    ...
                    <template v-slot:append>
                        <div class="pe-2">
                            <BtnOpenDialog :callback="() => openFiltrosRelatorio(relatorio)" :labelLeft="true"
                                :label="`Gerar relatório ${relatorio.tipoRelatorio} - ${relatorio.modeloRelatorio}`"
                                size="small" variant="elevated" color="info" icon="mdi-chart-donut-variant"
