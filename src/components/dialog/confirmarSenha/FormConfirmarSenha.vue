<template>
    <v-form ref="formRef" v-model="formIsValid">
        <v-row dense>
            <v-col cols="12">
                <v-text-field clearable v-model="confirmar.email_usuario"
                    :rules="[rules.required, rules.emailFormat]" label="email*" variant="outlined" disabled counter>
                </v-text-field>
            </v-col>
            <v-col cols="12" md="6">
                <v-text-field clearable v-model="confirmar.senha_usuario"
            ...
            <v-col cols="12" md="6">
                <v-text-field clearable v-model="confirmar.confirmar_senha"
                    :rules="[rules.required, rules.equals(() => confirmar.senha_usuario)]"
...
const confirmar = defineModel<ConfirmarSenha>('confirmar', { required: true });
