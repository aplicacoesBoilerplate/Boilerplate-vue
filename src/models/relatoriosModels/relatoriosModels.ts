...
export interface Relatorios {
    ...
    modeloRelatorio: "GERAL" | "USUARIO" | "FUNCIONARIO" | "SAIDA" | "AUTORIZACAO" | "CATEGORIA" | "MOTIVO" | "ERROS" | undefined;
}
...
export interface FiltrosDoRelatorio {
    ...
    condicao: "SELECAO" | "INTERVALO" | "INICIADO_COM" | "TERMINADO_COM" | "CONTEM" | "IGUAL" | "DIFERENTE" | "MAIOR" | "MAIOR_IGUAL" | "MENOR" | "MENOR_IGUAL" | "VERDADEIRO" | "FALSO" | "SEM_FILTRO" | null;
}
